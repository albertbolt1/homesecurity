...
def motiondetection():
    ...
    oupath1="C:/Users/albertbolt/sit/roytuts/gallery/media/motiondetection/thumbs/"
    ...
    while True: 
        ...
        if (motion>=3):
            ...
            cv2.imwrite(os.path.join(oupath,count1),img)
            cv2.imwrite(os.path.join(oupath1,count1),img)
            time1.append(datetime.now())